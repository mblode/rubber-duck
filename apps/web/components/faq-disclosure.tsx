 ...
 *
 * Each question is an `h2`, not an `h3`. There is no visible section heading to
 * sit above them, and jumping the page from `h1` to `h3` would leave a hole in
...
export const FaqDisclosure = () => (
  <section
    ...
    className="mt-16 border-white/10 border-t pt-2"
  >
    {faq.map((entry) => (
      <details
